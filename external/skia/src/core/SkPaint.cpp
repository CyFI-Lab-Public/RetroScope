...
#define GEN_ID_INC                  if (!zmbIsSafeAddr(this)) { fGenerationID++; }
#define GEN_ID_INC_EVAL(expression) if (!zmbIsSafeAddr(this) && expression) { fGenerationID++; }
#else
#define GEN_ID_INC
...
#define ZMB_EXTERNAL
#include "../../../../dalvik/vm/zombie/PatchVTable.h"
