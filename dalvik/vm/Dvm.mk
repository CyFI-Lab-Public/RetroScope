...
LOCAL_SRC_FILES := \
	...
	test/TestIndirectRefTable.cpp \
        zombie/MemMap.cpp \
        zombie/NewMemMap.cpp \
        zombie/Zombie.cpp \
        zombie/StructLib.cpp \
        zombie/InterpSwitches.cpp \
        zombie/hijack/hijack.cpp
#        zombie/PatchThread.cpp \
        zombie/Patch.cpp \
        zombie/VisitFuncs.cpp \
        zombie/PatchBinder.cpp \
        zombie/PatchBinderProxy.cpp \
        zombie/PatchMessageQueue.cpp \
        zombie/PatchDisplayEventReceiver.cpp \
        zombie/PatchInputEventReceiver.cpp \
        zombie/PatchParcel.cpp \
...
#LOCAL_EXPORT_C_INCLUDES += bionic/libc/kernel/arch-arm
