...
bool dvmCheckAsmConstants()
{
    ...
    extern void* dvmAsmInstruction_40[];
    extern void* dvmAsmInstruction_80[];
    extern void* dvmAsmInstruction_c0[];
#endif
...
#include "mterp/common/asm-constants.h"
    ...
    if (interpSize != 0 && interpSize != kNumPackedOpcodes*width) {
        ...
        ALOGE("The start,40,80,c0,end are %p, %p, %p, %p, %p", dvmAsmInstructionStart, dvmAsmInstruction_40, dvmAsmInstruction_80, dvmAsmInstruction_c0, dvmAsmInstructionEnd);
        dvmAbort();
    }
#endif
